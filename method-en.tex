...
a trivial solution is obtained in which the internal rewards converge at 0, and all units (excepting output units) select NOOP as their action.
...
We are trying to solve this problem with auction theory in the next subsection.
