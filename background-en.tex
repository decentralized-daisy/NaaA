...
%where $\mathcal{I}$ is a finite set of agents indexed 1, \dots, $N$, $\S$ represents a set of states, $\A^i$ stands for a set of actions, $\Trans$ denotes a transitive probability, and 
