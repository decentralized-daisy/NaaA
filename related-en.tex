...
Adaptive DropConnect (ADC), which we propose in a later part of this paper as a further application, extends DropConnect \citep{wan2013regularization}, a regularization technique.
